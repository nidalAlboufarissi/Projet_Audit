...
namespace Projet_Audit.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [Display(Name = "Nom")]
        [StringLength(60, ErrorMessage = "Nom doit comporter au moins 4 caractères.", MinimumLength = 4)]
        public string Nom { get; set; }

        [Required]
        [StringLength(60, ErrorMessage = "Prénom doit comporter au moins 4 caractères.", MinimumLength = 4)]
        [Display(Name = "Prénom")]
